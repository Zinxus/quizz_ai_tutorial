...
const UpgradePlan = () => {
    ...
    return(
    <button onClick={() => onNavigateToUpgrade(PRICE_ID)} className=" rounded-md 
    hover:bg-primary-shadow bg-primary-foreground p-10 sm:h-80 sm:w-80">
        <div className="flex items-center flex-col cursor-pointer w-full h-full">
            <div className="flex-1 flex items-center flex-col">
                <h2 className=" text-xl font-bold mb-4">Subscribe 
                    to Upload Documents and Generate Quizzes</h2>
